...
NEWS = [
    ...
    {"id": "n2", "category": "DÉCRYPTAGE", "title": "GPT Image 2.0 : l'image qui obéit enfin au mot près",
     ...
     "intro": "La promesse paraissait impossible : 'génère un visuel publicitaire avec ce slogan exact'. Pendant 3 ans, le texte était flou ou déformé. GPT Image 2.0 lit ton brief comme un humain. Démonstration.",
     "body": "## Les 4 avancées concrètes\n\n### Texte parfaitement lisible\nTu peux écrire 'Solde -30% du 1er au 7 mai' et le modèle l'imprime tel quel. Plus de typos générées, plus de texte qui se déforme. Pour les agences, c'est un gain de temps colossal.\n\n### Mains, mains, mains\nLes IA ont longtemps galéré avec les mains (5 doigts, anatomie correcte). GPT Image 2.0 les rend correctement dans 96% des cas. Tu peux générer des poses naturelles sans censurer les mains.\n\n### Contrôle de pose\nTu peux donner une silhouette de référence. Le modèle respecte la posture exacte. Idéal pour de la cohérence entre plusieurs visuels d'une même campagne.\n\n### Édition par phrase\n'Garde la lumière, change la veste pour un manteau noir long, retire le badge.' Plus besoin de masques. La phrase suffit.\n\n## Ce que ça veut dire pour les créatifs\n\n- **Designers** : 70% du temps de retouche disparaît.\n- **Marketing** : production de A/B visuels en 5 minutes.\n- **Indépendants** : un freelance peut produire un kit complet en une demi-journée.\n\n## Le débat éthique qui revient\n\nPlus c'est précis, plus on peut tromper. Réflexe pro : ajouter des watermarks discrets, garder une trace de génération, refuser la commande si elle imite trop fidèlement une personne réelle non consentante.\n\n## Verdict\n\nC'est le premier modèle d'image qui respecte un brief complet sans bricolage. La barrière entre 'idée visuelle' et 'visuel final' vient de tomber d'un cran. La créativité humaine (le brief, le goût) reprend toute sa valeur.",
     },
    ...
    {"id": "n4", "category": "FRANCE", "title": "Mistral, fierté française : pourquoi ça compte",
     ...
     "intro": "En 18 mois, une startup parisienne est devenue le 4e acteur mondial de l'IA générative. Mistral n'est pas qu'une fierté : c'est une preuve que l'Europe peut jouer dans la cour des grands.",
     "body": "## L'histoire en 3 dates\n\n- **Avril 2023** : trois chercheurs (ex-Meta, DeepMind) lancent Mistral à Paris.\n- **Septembre 2023** : sortie de Mistral 7B, modèle open-weight qui bat des modèles 5× plus gros.\n- **Avril 2026** : levée d'1Md€, Le Chat Pro adopté par 40% des administrations françaises.\n\n## Pourquoi ça compte vraiment\n\n### 1) Souveraineté technologique\nQuand l'IA devient l'infrastructure de demain, dépendre uniquement d'acteurs étrangers est un risque stratégique. Mistral nous donne une carte que personne n'avait en Europe.\n\n### 2) Excellence en français\nLes modèles US sont entraînés à 90% sur de l'anglais. Mistral pondère l'entraînement avec un corpus francophone massif. Résultat : ton français est plus naturel, idiomatique, sans tournures bizarres.\n\n### 3) Open-weight véritable\nMistral 7B, Mixtral 8x7B : tu peux les télécharger gratuitement, les héberger sur tes serveurs, les modifier. Cette ouverture redonne du pouvoir aux développeurs et aux entreprises qui ne veulent pas dépendre d'une API tierce.\n\n## Ce qui rend l'équipe singulière\n\n- **Une obsession produit** : sorties régulières, sans hype superflue.\n- **Une philosophie 'européenne'** : RGPD by design, contrats français, hébergement Paris.\n- **Une attention au coût** : leurs modèles sont taillés pour la production massive, pas seulement les benchmarks.\n\n## Le réflexe à adopter\n\nQuand tu choisis ton IA, ne demande plus 'quel est le meilleur modèle ?' mais 'quel est le meilleur modèle **pour mon contexte** ?'. Si ton contexte est européen, francophone, sensible au respect des données, Mistral est dans ta short-list.\n\n## Verdict\n\nIl n'y a pas eu de champion européen du logiciel pendant 30 ans. On en a un sur l'IA, qui est l'infrastructure des 30 prochaines. Soutenir Mistral (en l'utilisant, en en parlant), c'est concret.",
     },
