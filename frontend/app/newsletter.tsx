      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.hero}>
          ...
          <View style={styles.emailBox}>
            <TextInput
              ...
              placeholderTextColor="rgba(253,251,247,0.42)"
              keyboardType="email-address"
              autoCapitalize="none"
              style={styles.emailInput}
            />
            <TouchableOpacity style={styles.cta} onPress={() => openNewsletterSignup(undefined, email)}>
              <Sparkles size={16} color="#fff" strokeWidth={2.5} />
              <Text style={styles.ctaText}>Recevoir le digest</Text>
            </TouchableOpacity>
          </View>
          <Text style={styles.formNote}>Provisoire : le bouton ouvre un email prérempli, pour ne pas perdre les premiers inscrits avant Beehiiv/Substack.</Text>
        ...
        {NEWSLETTER_ISSUES.map((issue) => (
          <View key={issue.id} style={[styles.card, { backgroundColor: theme.surface, borderColor: theme.borderSubtle }]}> 
            ...
            <TouchableOpacity style={[styles.secondaryCta, { borderColor: theme.coral }]} onPress={() => openNewsletterSignup(issue.title, email)}>
...
const styles = StyleSheet.create({
  ...
  emailBox: { marginTop: spacing.lg, gap: 8 },
  emailInput: { borderWidth: 1, borderColor: "rgba(253,251,247,0.24)", borderRadius: radius.pill, paddingHorizontal: spacing.md, paddingVertical: 13, color: colors.textInverse, fontFamily: fonts.bodySemi, fontSize: 15 },
  cta: { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, backgroundColor: colors.coral, borderRadius: radius.pill, paddingVertical: 13, paddingHorizontal: spacing.md },
  ctaText: { color: "#fff", fontFamily: fonts.bodyBold, fontSize: 14 },
  formNote: { color: "rgba(253,251,247,0.62)", fontFamily: fonts.body, fontSize: 12, lineHeight: 17, marginTop: 8 },
  ...
  cardText: { fontFamily: fonts.body, fontSize: 14, lineHeight: 21, marginTop: 6, marginBottom: spacing.sm },
