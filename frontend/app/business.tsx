...
const styles = StyleSheet.create({
  ...
  metricLabel: { color: "rgba(253,251,247,0.66)", fontFamily: fonts.body, fontSize: 11, lineHeight: 15 },
  ...
  explainText: { fontFamily: fonts.body, fontSize: 13, lineHeight: 20 },
  ...
  price: { fontFamily: fonts.bodyBold, fontSize: 12, textAlign: "right" },
  audience: { fontFamily: fonts.bodyBold, fontSize: 11, letterSpacing: 1, textTransform: "uppercase", marginTop: 4 },
  ...
  proof: { fontFamily: fonts.body, fontSize: 12, lineHeight: 18, fontStyle: "italic", marginTop: spacing.sm },
  offerCta: { borderRadius: radius.pill, paddingVertical: 12, alignItems: "center", marginTop: spacing.md },
  offerCtaText: { color: "#fff", fontFamily: fonts.bodyBold, fontSize: 12 },
  ...
  ctaText: { fontFamily: fonts.body, fontSize: 13, lineHeight: 20, marginTop: 6 },
